...
TURTLEBOT3_ASSET_CFG = ArticulationCfg(
    # Points directly to the USD file you generated when placing it in your environment
    ...
    actuators={
        "wheels": ImplicitActuatorCfg(
            ...
            effort_limit=10.0,
            velocity_limit=5.0,
            stiffness=0.0,   # Set to 0 because we control differential wheels by Velocity
